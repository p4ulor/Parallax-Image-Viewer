...
@Composable
fun ExampleFullScreen2() = ParallaxView(
    backgroundContent = Content(ContentSettings(scale = 1.1f,)) {
        Image(
    ...
    middleContent = Content { TopBarAndGalaxyDropdownInfo() },
    foregroundContent = Content(ContentSettings(scale = 1.2f, alignment = Alignment.BottomCenter)) {
        Image(
...
@Composable
fun TopBarAndGalaxyDropdownInfo(){
